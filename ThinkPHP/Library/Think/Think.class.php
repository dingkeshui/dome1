...
class Think {
    ...
    static public function start() {
      ...
      if(!APP_DEBUG && Storage::has($runtimefile)){
          ...
          if(is_file(APP_PATH.'Home/Common/Lang/'.strtolower(C('DEFAULT_LANG')).'.php')) {
            L(include APP_PATH.'Home/Common/Lang/'.strtolower(C('DEFAULT_LANG')).'.php');
          }if(is_file(APP_PATH.'Admin/Common/Lang/'.strtolower(C('DEFAULT_LANG')).'.php')) {
              L(include APP_PATH.'Admin/Common/Lang/'.strtolower(C('DEFAULT_LANG')).'.php');
          }
