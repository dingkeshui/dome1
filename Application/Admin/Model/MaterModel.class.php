...
class MaterModel extends Model {
     ...
     * 查询多条数据
     */
    public function selectMater($where = array(),$order = '',$page_size = '',$parameter){
     ...
     * 编辑数据
     */
    public function editMater($where,$data){
