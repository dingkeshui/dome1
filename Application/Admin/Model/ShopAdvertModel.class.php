...
/**
 * Class ShopAdvertModel
 * @package Common\Model
 */
class ShopAdvertModel extends Model {
    protected $tableName = 'shop_advert';
    /**
     * @var array
     * 自动完成   新增时
     */
     ...
     * 查询多条数据
     */
    public function selectShopAdvert($where = array(),$order = '',$page_size = '',$parameter){
     ...
     * 添加数据
     */
    public function addShopAdvert($data){
        if(empty($data)){
            return false;
        }else{
     ...
     * 编辑数据
     */
    public function editShopAdvert($where,$data){
