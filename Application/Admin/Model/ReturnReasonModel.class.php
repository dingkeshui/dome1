...
class ReturnReasonModel extends Model {
    protected $tableName = 'return_reason';
    /**
     * @var array
     * 自动完成   新增时
     */
    protected $_auto = array (
        array('title','require','原因不能为空！',1,'',3), //空验证  默认情况下用正则进行验证
     ...
     * 查询多条数据
     */
    public function selectReason($where = array(),$order = '',$page_size = '',$parameter){
     ...
     * 编辑数据
     */
    public function editReason($where,$data){
