...
class CompanyModel extends Model {
    ...
    protected $_validate = array(
        array('content','require','功能介绍不能为空！',1,'',3), //空验证  默认情况下用正则进行验证
    );
     ...
     * 查询多条数据
     */
    public function selectFunction($where = array(),$order = '',$page_size = '',$parameter = array()){
     ...
     * 编辑数据
     */
    public function editFunction($where,$data){
