    ...
    var calendarSwitch = (function() {
        ...
        calendarSwitch.prototype = { /*说明：初始化插件*/
            ...
            init: function() {
                ...
                var html = "<div class='headerWrapper'><div class='headerTip'>请选择开始结束日期</div><div class='comfire'>完成</div></div><table class='dateZone'><tr><td class='colo'>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td class='colo'>六</td></tr></table>" + "<div class='tbody'></div>"
                ...
                for (var q = 0; q < me.index; q++) {
                    ...
                    currentDate.setMonth(currentDate.getMonth() + select - (me.index-1));
                        ...
                        if ($(this).text() == '结束') {
                            ...
                            $(me.sections).find('.tbody .rz').each(function(index, element) {
                                if ($(this).text() == '开始') {
                                    ...
                                    // var starttext=$(this).parent().text();
                                    // var day = parseInt(starttext.slice(0,starttext.indexOf("开始"))) //截取字符串中的数字可以选一天
                                    // console.log(day);
                                    // var dstr=$(this).parent().text();

                                    // var dday=dstr.slice(0,dstr.indexOf("开"));
                                    console.log(day);
                                    ...
                                    startDayYear = parseInt(startDayArrayYear.join(''));
                                    for (var i = 5; i < 7; i++) {
                                    ...
                                    console.log(startDayYear,startDayMonth,day);
                                    data.start=startDayYear+"-"+startDayMonth+"-"+day;
                                }
                                if ($(this).text() == '结束') {
                                    // var day = parseInt($(this).parent().text().replace(/[^0-9]/ig, "").substring(0, 2));
                                    var day = parseInt($(this).parent().text().split('结')[0]);
                                    console.log($(this).parent().text());
                                    if(day < 10){
                                        day = "0" + day;
                                    }
                                    ...
                                    console.log("结束=",endDayYear,endDayMonth,day);
                                    data.end=endDayYear+"-"+endDayMonth+"-"+day;
            ...
            _initselected: function() {
                ...
                var arry = [];
                var arry1 = [];
                var tds = $(me.sections).find('.dateTable:last-child').find('td');
                ...
                $(arry1).on('click', function(index) {
                    ...
                    if($('.calendar').css('display') != "none"){
                        ...
                        if (flag == 0) {
                            ...
                            $(this).append('<p class="rz dingks">开始</p>');
