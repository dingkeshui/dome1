...
function getRootPath(){
    ...
    if (!localhostPaht) {
    	localhostPaht = "https://www.qufutong.me/";
    }else if (localhostPaht == "https:" || localhostPaht == "http:") {
		localhostPaht += "//www.qufutong.me";
	}
...
*
*/ 
function isTrueTime(curtime,URL){
	var start = new Date('2018-02-13').getTime();
	var end = new Date('2018-02-24 10:00').getTime();
	var closeUrl = [
		"/index.php?s=/Api/Goods/exchangeInter",
		"/index.php?s=/Api/Member/sign",
		"/index.php?s=/Api/ProductOrder/addOrder",
		"/index.php?s=/Api/HxUser/withdraw",
		"/index.php?s=/Api/HxUser/transfer",
		"/index.php?s=/Api/Member/is_set",
		"/index.php?s=/Api/Roll/raffle",
		"/index.php?s=/Api/Order/payBill",
		"/index.php?s=/Api/Coupon/useCoupon",
		"/index.php?s=/Pay/getHxApi",
		"/index.php?s=/Api/Merchant/sign",
		"/index.php?s=/Api/Goods/exchange",	
		"/index.php?s=/Newweb/Pay/getHxApi",
		"/index.php?s=/Newweb/Pay/getHxShopOrderApi",
		"/index.php?s=/Pay/getHxShopOrderApi",
		"/index.php?s=/Newweb/Accounts/transferuser",
		"/index.php?s=/Accounts/transferuser",
		
	];
	if (curtime>start && curtime<end) {
		if (closeUrl.indexOf(URL) != -1 ) return false;
	}
	return true;
}
...
function requestUrl(URL,DATA,CALLBACK,TYPE,ISLOAD,DATATYPE){
	...
	if (ISLOAD) $(".xq_loadding").show();
	var times = new Date().getTime();

	if (!isTrueTime(times,URL)) {
		layer.msg("该项功能维护中！");
		$(".xq_loadding").hide();
		setTimeout(function(){
			layer.closeAll();
	...
	if(sessionStorage.getItem("is_readonly")){
	...
	$.ajax({
		...
		"type" : TYPE,
		"headers" : {
	        "token" : "9b8993e4f70e4db7f001d338d7797480"
	    },
