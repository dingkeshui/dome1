...
class ApplySignAbstractRequest extends RichServiceRequest{
    ...
    function validate(){
        ...
        $this->isFqgz=$this->trim($this->isFqgz);
        ...
        if($this->attachFile1!=null&&!is_a($this->attachFile1, 'org\ebq\api\model\bean\UploadFile')){
            throw new RuntimeException("attachFile1 is not a UploadFile value");
        }
        if($this->attachFile2!=null&&!is_a($this->attachFile2, 'org\ebq\api\model\bean\UploadFile')){
            throw new RuntimeException("attachFile2 is not a UploadFile value");
        }
        if($this->attachFile3!=null&&!is_a($this->attachFile3, 'org\ebq\api\model\bean\UploadFile')){
