...
class ClientInfo{
	...
	//sandbox
	static $services_url = 'http://api.junziqian.com/services';
	//app_key对应从服务商申请到的appkey
	static $app_key = "7c93152d68009574";//'请输入$app_secret';
	//appkey对应的密钥,客户使用,不能公开
	static $app_secret = "4c29b46d7c93152d68009574521ed64d";//'请输入$app_secret';
